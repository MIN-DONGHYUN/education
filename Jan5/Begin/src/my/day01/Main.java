...
//import my.day02.Member;    /원래는 설정해야하는데 다른 패키지에 있으면 사용해야 한다.
...
public class Main {
	...
	public static void main(String[] args) {
	   ...
	   mindhmbr.address = "경기도 고양시";   // 인스턴스 변수를 사용하면 경고가 생기고 원하는데로 실행 안됨
	   ...
	   Member.address = "경기도 의정부시";
	   // static 변수는 클래스명.static변수명으로 사용한다.
