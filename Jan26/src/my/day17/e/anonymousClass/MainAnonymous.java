...
public class MainAnonymous {
	...
	public static void main(String[] args) {
		...
		// 이 자체가 클래스가 되어진다.
		InterArea areaObj = new InterArea() {	//인스턴스 생성
		...
		System.out.println("밑변 10.5, 높이 5.5 인 삼각형의 면적은 " + areaSize3 + " 입니다.");
		//밑변 10.5, 높이 5.5 인 삼각형의 면적은 28.875 입니다.
